...
namespace Zezo.Models
{
    public partial class rsc_v2Context : DbContext
    {
        ...
        public virtual DbSet<CertificateViewLayoutEdit3> CertificateViewLayoutEdit3s { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseNpgsql("Server=81.21.104.178;Port=5432;User Id=postgres;Password=+n5Bk2DGYbFt4tr5QDCc1a!;Database=rsc_v2;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CertificateViewLayoutEdit3>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("certificate_view_layout_edit3");
                ...
                entity.Property(e => e.AssignmentsCert).HasColumnName("assignments_cert");

                entity.Property(e => e.AssignmentsPrintStatus).HasColumnName("assignments_print_status");

                entity.Property(e => e.AssignmentsSurveyReview).HasColumnName("assignments_survey_review");

                entity.Property(e => e.AssignmentsTawheed).HasColumnName("assignments_tawheed");
